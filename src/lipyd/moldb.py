...
class MoleculeDatabaseAggregator(object):
    ...
    def _dec_lookup_daltons_tolerance(self, func):
        ...
        def _lookup_daltons_tolerance(*args, **kwargs):
            
            self._daltons_tolerance = True
        ...
        return _lookup_daltons_tolerance
    
    
    def adduct_lookup_daltons_tolerance(
            self,
            mz,
            adducts = None,
            ionmode = None,
...
def adduct_lookup_daltons_tolerance(
    ...
    return db.adduct_lookup_daltons_tolerance(
        mz,
        ionmode = ionmode,
        adduct_constraints = adduct_constraints,
        tolerance = tolerance,
