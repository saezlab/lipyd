    ...
    'ex2ad': {
        1: {
            ...
            'neg': {
                ...
                '[M-H+Na+3x(HCOONa)]-': 'remove_h_add_na_3nafo',
                '[M-H+Na+4x(HCOONa)]-': 'remove_h_add_na_4nafo',
                '[M-H+Na+5x(HCOONa)]-': 'remove_h_add_na_5nafo',
                '[M-H+Na+6x(HCOONa)]-': 'remove_h_add_na_6nafo',
                '[M-H+Na+7x(HCOONa)]-': 'remove_h_add_na_7nafo',
            }
        },
        2: {
            'pos': {},
