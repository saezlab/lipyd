...
data <- read.csv('final_results_E.csv', sep = '\t', header = TRUE)
...
p <- ggplot(adata12[!is.nan(adata12$unsat),], aes(carb, fill = ionm)) +
...
ggsave('gg_rt_hg_cc_boxplot.pdf', device = cairo_pdf, width = 48, height = 6)
...
ggsave('gg_rt_hg_cc_class_point.pdf', device = cairo_pdf, width = 48, height = 6)
...
ggsave('gg_rt_hg_cc_class_protein_point.pdf', device = cairo_pdf, width = 48, height = 6)
...
ggsave('gg_cc_hg_size.pdf', device = cairo_pdf, width = 24, height = 9)
...
ggsave('gg_facc_hg_size.pdf', device = cairo_pdf, width = 48, height = 9)
...
ggsave('gg_cc_protein_size.pdf', device = cairo_pdf, width = 36, height = 12)
...
ggsave('gg_facc_protein_size.pdf', device = cairo_pdf, width = 48, height = 8)
...
ggsave('gg_hg_cc_protein_size.pdf', device = cairo_pdf, width = 48, height = 9)
...
p <- ggplot(adata12ccfa, aes(x = hgfa, y = protein, color = uhgroup)) +
    ...
    theme(axis.title = element_text(size = 24),
        axis.text = element_text(size = 18),
        axis.text.x = element_text(angle = 90, vjust = 0.5, size = 6, hjust = 1),
...
ggsave('gg_hg_facc_protein_size.pdf', device = cairo_pdf, width = 64, height = 12, limitsize = FALSE)
...
ggsave('gg_cc_hg_int_size.pdf', device = cairo_pdf, width = 36, height = 9)
...
ggsave('gg_facc_hg_int_size.pdf', device = cairo_pdf, width = 48, height = 9)
...
ggsave('gg_cc_protein_int_size.pdf', device = cairo_pdf, width = 30, height = 12)
...
ggsave('gg_all_cc_protein_int_class_size.pdf', device = cairo_pdf, width = 36, height = 12)
...
ggsave('gg_cc_protein_int_class_size.pdf', device = cairo_pdf, width = 36, height = 12)
...
ggsave('gg_cc_protein_int_class_hg_text.pdf', device = cairo_pdf, width = 36, height = 12)
...
ggsave('gg_facc_protein_int_size.pdf', device = cairo_pdf, width = 48, height = 12)
...
ggsave('gg_hg_cc_protein_int_size.pdf', device = cairo_pdf, width = 56, height = 9, limitsize = FALSE)
...
ggsave('gg_hg_cc_protein_int_class_size.pdf', device = cairo_pdf, width = 64, height = 9, limitsize = FALSE)
...
ggsave('gg_all_hg_cc_protein_int_class_size.pdf', device = cairo_pdf, width = 108, height = 9, limitsize = FALSE)
###
...
ggsave('gg_hg_facc_protein_int_size.pdf', device = cairo_pdf, width = 108, height = 12, limitsize = FALSE)
